...
const validOrigins = ['zipcode', 'gg25', 'district', 'kantone', 'gazetteer', 'address', 'parcel'] as const
...
export const LOCATION_SEARCH_ORIGINS: OriginType[] = ['address', 'zipcode', 'district', 'kantone', 'gazetteer', 'address', 'parcel']
